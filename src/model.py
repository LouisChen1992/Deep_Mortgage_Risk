...
class Model:
	def __init__(self, config, force_var_reuse=False):
		self._config = config
	...
	# def train(self, sess, dl, num_epochs, logdir, saver):
	...
	# 		count = 0
	# 		for i, (x, y, info) in enumerate(dl.iterate_one_epoch(self._config.batch_size)):
